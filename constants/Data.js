// Hi there! I’m a bike messenger by day, aspiring millionaire by night, all thanks to the magnificent savings skills I got from using Susubox App. I live in Nima, Accra Ghana but will be moving to Trasaco soon. (Don’t sleep on this app.)

// Nii Papafio Lamptey

// …still not convinced?

// Since Susubox, I have been able to make bold financial moves because I have already seen the future!. Yes, that’s what it is… this app allows you to see into the future of your finances. Things have never been the same since!
...
const Data = [
  {
    ...
    body: [
      ...
      '10. Beware of spending money on periodic purchases like gifts, vacation, you know the rest',
    ],
  },
  {
    id: 2,
